...
- Recall-biased: default to PLAUSIBLE — never refute a candidate merely for feeling speculative or unlikely. Return REFUTED only on constructive proof: a quoted guard that prevents the scenario, or a demonstrated impossibility of the path. CONFIRMED as in neutral.
